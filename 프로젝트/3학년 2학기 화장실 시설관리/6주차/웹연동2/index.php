                ...
                <tr>
                    <td>
                        <div id="options">
                            ...
                            <p>온습도차 : <span id="value">'. abs($row['intemp'] - $row['outtemp']) .'℃, '. abs($row['inhumi'] - $row['outhumi']) .'%</span> | 미세먼지 : <span id="value11"></span> <span id="warning11">■</span> | 냄새 : <span id="value12">'. $row['camic'] .'</span> <span id="warning12">■</span></p>
                        </div>
                    </td>
                    <td>
                        <div id="options">
